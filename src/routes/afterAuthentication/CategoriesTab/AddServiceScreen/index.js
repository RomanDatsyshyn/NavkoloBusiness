...
export const AddServiceScreen = ({navigation, navigation: {goBack}}) => {
  ...
  const sendRequest = () => addService({name});
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View>
            <View style={styles.labels}>
              ...
              <TextBlock text={'Нової послуги'} size={1} lightBlue boldest />
