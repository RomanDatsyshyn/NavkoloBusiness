...
export const ListOfServicesScreen = ({
  ...
  const {services, selectedServices} = route.params;
    ...
    <View style={styles.background}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.title}>
          <TextBlock text={'Оберіть послуги,'} size={2} lightBlue boldest />
          <TextBlock text={'які ви надаєте'} size={2} lightBlue boldest />
        </View>
